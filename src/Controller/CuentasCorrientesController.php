...
class CuentasCorrientesController extends AbstractController
{
    ...
    {
        return $this->render('cuentas_corrientes/show.html.twig', ['cuentas_corriente' => $cuentasCorriente]);
    }
    ...
    public function edit(Request $request, CuentasCorrientes $cuentasCorriente): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('cuentas_corrientes_index', ['id' => $cuentasCorriente->getId()]);
        }
